...
export const StartScreen = () => {
  return (
    <View style={styles.center}>
      <ImageBackground source={require('../images/StartScreenImg.jpg')} resizeMode="cover" style={styles.image}>
      <StatusBar
        animated={true}
        ...
        <View style={styles.authentificationContainer}>
          <Text style={{ color: 'black', fontSize: 20, fontWeight: 'bold', }}>Welcome to Strange Places</Text>
          <Text
