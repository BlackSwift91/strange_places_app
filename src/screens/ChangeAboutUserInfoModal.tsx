...
import { View, StyleSheet, TextInput, StatusBar, Dimensions, Keyboard } from 'react-native';

import { THEME } from '../theme';
import { IChangeAboutUserInfoModal } from '../interfaces/INavigation';
import { NavigationButton } from '../components/NavigationButton';
import { HeaderButtons, Item } from 'react-navigation-header-buttons';

const windowWidth = Dimensions.get('window').width;

export const ChangeAboutUserInfoModal: React.FC<IChangeAboutUserInfoModal> = ({
  navigation,
  route,
}) => {
        ...
        <HeaderButtons HeaderButtonComponent={NavigationButton}>
          <Item
            ...
            onPress={async () => {
              ...
              navigation.navigate('ChangeProfile', { textInput: text });
            }}
          />
        </HeaderButtons>
      ),
